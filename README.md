...
- [설치](#설치)
- [엔진 등록](#엔진-등록)
- [로컬 플러그인 작성 가이드](#플러그인-작성-가이드)
- [원격 플러그인 서버 작성 가이드](#원격-플러그인에-등록-가능한-서버-예시)
- [라이선스](#라이선스)
...
## 원격 플러그인에 등록 가능한 서버 예시

- 저장소를 참고하세요.
[원격 플러그인 전용 서버 안내](https://github.com/oxxultus/liminal-desktop-remote-server)
